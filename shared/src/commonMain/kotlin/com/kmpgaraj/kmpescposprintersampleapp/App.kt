...
import dev.escpos.sample.presentation.SampleApp
 ...
 * content/print-log sample UI. [context] is whatever `platformTextMeasurer` needs on the calling
 * platform (an Android `Context`, `Unit` everywhere else).
 */
@Composable
