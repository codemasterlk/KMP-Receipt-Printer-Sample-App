...
/** Nothing is needed to build a font resolver on desktop/Skiko — `createFontFamilyResolver()`
 *  takes no argument there. */
actual typealias PlatformContext = Unit

actual suspend fun platformTextMeasurer(context: PlatformContext): TextMeasurer =
    TextMeasurer(
